...
export class DOMBuilder {
  ...
  static initializeGameInfo() {
    ...
    buttonsContainer.appendChild(
      this.createButton("hit-btn", "Hit", "btn btn-hit")
    );
    buttonsContainer.appendChild(
      this.createButton("stand-btn", "Stand", "btn btn-stand")
    );
    buttonsContainer.appendChild(
      this.createButton("next-btn", "Next Game", "btn btn-next")
    );
    buttonsContainer.appendChild(
      this.createButton("lobby-btn", "Back to Lobby", "btn btn-secondary")
    );
  }
  ...
  static createCardElement(card, isFaceUp = true, backDesign = "player") {
    ...
    if (isFaceUp && !card.isHidden) {
      ...
      img.onerror = () => {
        console.warn(
          `Card back image not found for design: ${backDesign}, using fallback`
        );
